...
/// </summary>
public abstract class MyEndpointDataSource
{
    /// <summary>
    ...
    /// <summary>
    /// Get the <see cref="Endpoint"/> instances for this <see cref="MyEndpointDataSource"/> given the specified <see cref="RouteGroupContext.Prefix"/> and <see cref="RouteGroupContext.Conventions"/>.
    /// </summary>
    ...
    public virtual IReadOnlyList<Endpoint> GetGroupedEndpoints(RouteGroupContext context)
    {
        ...
        for (int i = 0; i < endpoints.Count; i++)
        {
            ...
            {
                throw new NotSupportedException(MyResources.FormatMapGroup_CustomEndpointUnsupported(endpoint.GetType()));
            }
