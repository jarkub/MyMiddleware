...
/// <summary>
/// Represents an <see cref="MyEndpointDataSource"/> whose values come from a collection of <see cref="MyEndpointDataSource"/> instances.
/// </summary>
[DebuggerDisplay("{DebuggerDisplayString,nq}")]
public sealed class MyCompositeEndpointDataSource : MyEndpointDataSource, IDisposable
{
    private readonly object _lock = new();
    private readonly ICollection<MyEndpointDataSource> _dataSources;
    ...
    internal MyCompositeEndpointDataSource(ObservableCollection<MyEndpointDataSource> dataSources)
    {
    ...
    /// <summary>
    /// Instantiates a <see cref="MyCompositeEndpointDataSource"/> object from <paramref name="endpointDataSources"/>.
    /// </summary>
    /// <param name="endpointDataSources">An collection of <see cref="EndpointDataSource" /> objects.</param>
    /// <returns>A <see cref="MyCompositeEndpointDataSource"/>.</returns>
    public MyCompositeEndpointDataSource(IEnumerable<MyEndpointDataSource> endpointDataSources)
    {
        _dataSources = new List<MyEndpointDataSource>();
    ...
    /// </summary>
    public IEnumerable<MyEndpointDataSource> DataSources => _dataSources;
